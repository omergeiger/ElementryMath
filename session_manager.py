...
class SessionSummary:
    def __init__(self, total_score, passed, correct_count, incorrect_count):
...
class SessionManager:
    ...
    def get_summary(self, present=True, score_threshold=50):
        ...
        session_summary = SessionSummary(total_score, passed, correct_count, incorrect_count)
        if present:
